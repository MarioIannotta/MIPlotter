...
- (BOOL)addPlotOf:(NSArray *)values withLineColor:(UIColor *)lineColor fillColor:(UIColor *)fillColor andID:(NSString *)plotID {
    ...
    /*
    MISinglePlot *plot = [[MISinglePlot alloc] initWithFrame:CGRectMake(0, 0, self.backgroundView.frame.size.width, self.backgroundView.frame.size.height) andValues:values];
    ...
    [self.backgroundView addSubview:plot];
    */
...
- (void)calcTheYMaxOfAllPlot {
    ...
    self.yMax = [self max:initialPlot.values];
